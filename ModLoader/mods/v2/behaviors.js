(function() {
    ...
    let behaviors = {
        init() {
            ...
            alert("This mod was created by OvOPlant, ported to OvO 2 by OvOPlant. Press Shift + Y to change the behaviors.")
        },
        ...
        pausing() {
            penable = prompt('This will allow you to pause the game just like OvO (Esc or P). There will not be a pause menu. If you want one, use the "pausemenu" mod instead. (Try to pause while player/movearea timescale is set to 1) To enable pausing, type "enable". To disable pausing, type "disable".')
            if (penable === "enable"){
